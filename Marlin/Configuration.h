...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  36.97,  36.97 }
    #define DEFAULT_Ki_LIST {   5.47,   5.47 }
    #define DEFAULT_Kd_LIST {  62.46,  62.46 }
  #else
    #define DEFAULT_Kp  36.97
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 67.14
  #define DEFAULT_bedKi 13.14
  #define DEFAULT_bedKd 228.72
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -10, -2.40 }
